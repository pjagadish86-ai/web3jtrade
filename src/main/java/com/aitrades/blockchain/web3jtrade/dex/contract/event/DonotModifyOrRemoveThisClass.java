...
public class DonotModifyOrRemoveThisClass extends Contract {
    ...
    @Deprecated
    protected DonotModifyOrRemoveThisClass(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected DonotModifyOrRemoveThisClass(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected DonotModifyOrRemoveThisClass(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected DonotModifyOrRemoveThisClass(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    @Deprecated
    public static DonotModifyOrRemoveThisClass load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new DonotModifyOrRemoveThisClass(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static DonotModifyOrRemoveThisClass load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new DonotModifyOrRemoveThisClass(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static DonotModifyOrRemoveThisClass load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new DonotModifyOrRemoveThisClass(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static DonotModifyOrRemoveThisClass load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new DonotModifyOrRemoveThisClass(contractAddress, web3j, transactionManager, contractGasProvider);
    }
