...
import org.web3j.protocol.parity.methods.request.ParityPendingTransactionRequest;
...
public class JsonRpc2_0Parity extends JsonRpc2_0Admin implements Parity {
	...
	@Override
	public Request<?, ParityPendingTransactionResponse> parityPendingTransactionsDummy(
			ParityPendingTransactionRequest parityPendingTransactionRequest) {
		// TODO Auto-generated method stub
		return null; 
	}

	@Override
	public Request<?, ParityPendingTransactionResponse> parityPendingTransactions(Integer limit, ParityPendingTranscationFilter parityPendingTranscationFilter) {
		 return new Request<>(
	                "parity_pendingTransactions", Arrays.asList(limit, parityPendingTranscationFilter), web3jService, ParityPendingTransactionResponse.class);
	    }
