...
public interface Parity extends Admin, Trace {
    ...
    Request<?, ParityPendingTransactionResponse> parityPendingTransactionsDummy(ParityPendingTransactionRequest parityPendingTransactionRequest);
    
    Request<?, ParityPendingTransactionResponse> parityPendingTransactions(Integer limit, ParityPendingTranscationFilter parityPendingTranscationFilter);
}
